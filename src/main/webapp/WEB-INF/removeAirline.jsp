...
<title>Remove Airline Form</title>
<link rel="stylesheet"
	...
	<div class="collapse navbar-collapse" id="navbarText">
		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown"><a
				...
				aria-haspopup="true" aria-expanded="false">Remove Record(s)</a>
			...
			<li>
				<form class="form-inline my-2 my-lg-0" action="RemoveAirlinesSearch"
					method="post">
		...
		<span class="navbar-text" style="color: #E0FFFF; margin-right: 250px">
			"Search for an airline to REMOVE using a keyword." </span>
		<button class="btn btn-danger navbar-btn" onclick="history.go(-1)">Go
			Back</button>
	</div>
	</nav>
	<br/><br/>
	<div class="text-center"><img src="images/home.jpg" class="rounded" alt="https://images.app.goo.gl/rmciK63v5ozyr7z86" style="max-width:50%;"></div>
	<h2 class="text-center">Remove an Airline record</h2>
