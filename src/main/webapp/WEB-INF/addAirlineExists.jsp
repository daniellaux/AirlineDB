...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <a
	...
	<blockquote class="blockquote text-center">
		<p class="mb-0" style="color:#DH143C;">
			Airline Id already in use.
		</p>
		<footer class="blockquote-footer">Please revise your input before re-submitting.</footer>
	</blockquote>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="number" name="id" class="form-control"
					placeholder="Enter a number" value="${airline.id}">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="name" class="form-control"
					placeholder="Enter name of the Airline" value="${airline.name}">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="alias" class="form-control"
					placeholder="Enter name of the Airline" value="${airline.alias}">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="iataCode" class="form-control"
					placeholder="2 letter IATA code" value="${airline.iataCode}">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="icaoCode" class="form-control"
					placeholder="4 letter ICAO code" value="${airline.icaoCode}">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="callsign" class="form-control""airlines.dat"
					placeholder="Enter the airline's Callsign" value="${airline.callsign}">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="country" class="form-control"
					placeholder="Base Country of Operation" value="${airline.country}">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="operationalStatus" class="form-control"
					placeholder="Enter Y or N" value="${airline.operationalStatus}">
			</div>
		</div>
